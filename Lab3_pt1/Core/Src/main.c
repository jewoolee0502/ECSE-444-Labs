...
void sineGraph(void) {
	for(int i = 0; i<PERIOD; i++) { //PERIOD=15 samples
		sine[i] = (uint16_t)((arm_sin_f32((2*M_PI*i)/15)+1)*1890); //+1 to shift the sine graph above the x-axis (and multiply 1890 to shift by that value)
	}
}
