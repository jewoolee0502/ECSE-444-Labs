...
void buttonbutton_status(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(PressButton, buttonbutton_status, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_buttonbutton_status */
/**
  * @brief  Function implementing the PressButton thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_buttonbutton_status */
void buttonbutton_status(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
